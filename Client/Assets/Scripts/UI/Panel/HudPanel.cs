...
namespace SmallUniverse.UI
{
    public class HudPanel : PanelBase
    {
        ...
        public HudPanel(params string[] _parameters) : base()
        {
            pname = PanelName.HudPanel;
            view = PanelMap.GetView(pname) as HudPanelView;
            mainPackage = "hud_panel";
